          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                :key="spuSaleAttrValue.id" @click="changeChecked(spuSaleAttrValue, spuSaleAttr.spuSaleAttrValueList)">
...
<script>
  ...
  export default {
    ...
    methods: {
      changeChecked(current, arr) {
        arr.forEach(item => item.isChecked = '0')
        current.isChecked = '1'
      },
      changeSkuNum() {
        if(isNaN(this.skuNum) || this.skuNum === '' || this.skuNum < 1) {
          this.skuNum = 1
        }else {
